...
if ($id_cliente) {
    ...
    if (!$cliente) {
        echo "<p>Erro: Cliente não encontrado.</p>";
        exit;
    }
} else {
    echo "<p>Erro: ID do cliente não foi fornecido.</p>";
    exit;
}
?>
    ...
    <form action="?page=salvar" method="POST">
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="whatsapp" name="whatsapp">
                <option value="1" <?php echo ($cliente['whatsapp'] ?? 0) == 1 ? 'selected' : ''; ?>>Sim</option>
                <option value="0" <?php echo ($cliente['whatsapp'] ?? 0) == 0 ? 'selected' : ''; ?>>Não</option>
            </select>
        </div>
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="recebe_email" name="recebe_email">
                <option value="1" <?php echo ($cliente['recebe_email'] ?? 0) == 1 ? 'selected' : ''; ?>>Sim</option>
                <option value="0" <?php echo ($cliente['recebe_email'] ?? 0) == 0 ? 'selected' : ''; ?>>Não</option>
            </select>
        </div>
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="sms" name="sms">
                <option value="1" <?php echo ($cliente['sms'] ?? 0) == 1 ? 'selected' : ''; ?>>Sim</option>
                <option value="0" <?php echo ($cliente['sms'] ?? 0) == 0 ? 'selected' : ''; ?>>Não</option>
            </select>
        </div>
